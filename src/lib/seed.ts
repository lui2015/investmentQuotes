...
const quotes = [
  ...
  // 索罗斯
  { id: v4(), content_cn: "世界经济史是一部基于假象和谎言的连续剧。", content_en: "The history of economic is a never-ending series of episodes based on falsehoods and lies.", master_id: "m-soros", source: "金融炼金术", source_year: 1987, is_featured: 0, tags: ["t-market"] },
